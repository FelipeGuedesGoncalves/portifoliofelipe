...
return(
    <div className="h-full w-full flex flex-wrap xl:w-300 w-full justify-center">
        <button className="card h-70 w-90 m-5 flex justify-center items-center" >
            <Image alt="" src={"/BabyCare.png"} width={360} height={200}/>
        </button>
        <button className="card h-70 w-90 m-5 flex justify-center items-center" >
            <Image alt="" src={"/InsightWise.png"} width={360} height={200}/>
        </button>
        <button className="card h-70 w-90 m-5 flex justify-center items-center" >
            <Image alt="" src={"/HeatWise.png"} width={360} height={200}/>
        </button>
        <button className="card h-70 w-90 m-5 flex justify-center items-center" >
            <Image alt="" src={"/Hunzer.png"} width={360} height={200}/>
        </button>
        <button className="card h-70 w-90 m-5 flex justify-center items-center" >
            <Image alt="" src={"/PortoBike.png"} width={360} height={200}/>
        </button>
        <button className="card h-70 w-90 m-5 flex justify-center items-center" >
            <Image alt="" src={"/GridHub.png"} width={360} height={200}/>
        </button>
        <button className="card h-70 w-90 m-5 flex justify-center items-center" >
            <Image alt="" src={"/BlueHope.png"} width={360} height={200}/>
        </button>
