...
export default function PortShow() {
    const projects = [
        ...
        {
            img: "/BabyCare.png",
            desc: "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quia quisquam consectetur dignissimos, optio, nulla voluptate neque rerum ducimus veritatis dolorum nobis aspernatur nesciunt temporibus corporis, rem at! Dicta, nesciunt enim?",
            figmaLink: "",
            appLink: ""
        }
    ];
